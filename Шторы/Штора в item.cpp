/*
{
    ...
    {name:"B00",type:"devices-list",required:true,filter:["jalousie"],width:888,desc:"Штора"},
	]
}
*/
...
V-ID/V-ADDR
{
    ...
    if ( ([B00.0]&7)==4 && i==1 ) {setStatus(B00, 0);} else
    if ( ([B00.0]&7)==4 && i==0 ) {setStatus(B00, 1);} else
    {setStatus(B00, 1);}
}