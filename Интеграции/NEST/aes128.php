 ...
 * Cifrado / Descifrado de datos mediante AES 128

 *

 * Autor: Jos� Manuel Busto L�pez
 ...
 * Copyright (C) 2007  Jos� Manuel Busto L�pez
...
class AES128 {
    ...
    /* Definici�n de la S-box inversa (para el descifrado) */
    ...
    /* Definici�n de los valores de la funci�n rcon */
    ...
    /* Definicion de 0x02*state[i][j] en GF(2^8) (para MixColumns)*/
    ...
    /* Definicion de 0x03*state[i][j] en GF(2^8) (para MixColumns)*/
    ...
    /* Definicion de 0x09*state[i][j] en GF(2^8) (para InvMixColumns)*/
    ...
    /* Definicion de 0x0e*state[i][j] en GF(2^8) (para InvMixColumns)*/
    ...
    var $Nr=10;//N�mero de rondas 128b=>10

    var $Nb=4;//N�mero de columnas en el state (siempre 4)
   ...
   /**
     ...
     * @param debug Si es verdadero muestra informaci�n de debug
