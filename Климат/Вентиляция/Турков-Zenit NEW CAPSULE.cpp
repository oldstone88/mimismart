...
u8 cond [5];
u8 read[8]={Address, 0x03, 0x00, 0x01, 0x00, 0x04, 0xCC, 0x16};
u8 send[17]={Address, 0x10, 0x00, 0x01, 0x00, 0x04, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xCC, 0x16};
u8 block=0;
...
//Опрос вентиляции
V-ID/s:5{
    !block?setStatus(RS485, &read):(block=0);
}
