...
void check()
{
    if (optl==15)
    {
        ...
        if (opt(0)==ID1 && opt(1)==0x03)
        {
            ...
            if ((opt(4)-16)!=[COND1.1] && opt(4)>15) {k[1]=(opt(4)-16); write=1; srvError("Температура");}
            if ((opt(6)-1)!=[COND1.4] && opt(6)!=0) {k[4]=(opt(6)-1); write=1; srvError("Обдув");}
        ...
        if (opt(0)==ID2 && opt(1)==0x03)
        {
            ...
            if ((opt(4)-16)!=[COND2.1] && opt(4)>15) {k[1]=(opt(4)-16); write=1; srvError("Температура"); srvError("Байт=%d, Конд=%d", opt(4), [COND2.1]);}
            if ((opt(6)-1)!=[COND2.4] && opt(6)!=0) {k[4]=(opt(6)-1); write=1; srvError("Обдув");}
        ...
        if (opt(0)==ID3 && opt(1)==0x03)
        {
            ...
            if ((opt(4)-16)!=[COND3.1] && opt(4)>15) {k[1]=(opt(4)-16); write=1; srvError("Температура");}
            if ((opt(6)-1)!=[COND3.4] && opt(6)!=0) {k[4]=(opt(6)-1); write=1; srvError("Обдув");}
        ...
        if (opt(0)==ID4 && opt(1)==0x03)
        {
            ...
            if ((opt(4)-16)!=[COND4.1] && opt(4)>15) {k[1]=(opt(4)-16); write=1; srvError("Температура");}
            if ((opt(6)-1)!=[COND4.4] && opt(6)!=0) {k[4]=(opt(6)-1); write=1; srvError("Обдув");}
        ...
        if (opt(0)==ID5 && opt(1)==0x03)
        {
            ...
            if ((opt(4)-16)!=[COND5.1] && opt(4)>15) {k[1]=(opt(4)-16); write=1; srvError("Температура");}
            if ((opt(6)-1)!=[COND5.4] && opt(6)!=0) {k[4]=(opt(6)-1); write=1; srvError("Обдув");}
        ...
        if (opt(0)==ID6 && opt(1)==0x03)
        {
            ...
            if ((opt(4)-16)!=[COND6.1] && opt(4)>15) {k[1]=(opt(4)-16); write=1; srvError("Температура");}
            if ((opt(6)-1)!=[COND6.4] && opt(6)!=0) {k[4]=(opt(6)-1); write=1; srvError("Обдув");}
        ...
        if (opt(0)==ID7 && opt(1)==0x03)
        {
            ...
            if ((opt(4)-16)!=[COND7.1] && opt(4)>15) {k[1]=(opt(4)-16); write=1; srvError("Температура");}
            if ((opt(6)-1)!=[COND7.4] && opt(6)!=0) {k[4]=(opt(6)-1); write=1; srvError("Обдув");}
