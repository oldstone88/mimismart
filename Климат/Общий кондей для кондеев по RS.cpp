...
selectArea:true,
addItems:[
    {tag:"item", id:"%TARGET%", name:"NAME", "sub-id":"%SUBID%", type:"conditioner", "t-delta":"14", "t-min":"16", "vane-hor":"0x00", "vane-ver":"0x00", "funs":"0x01", "modes":"0x00"},
    ],
vars:[
...
V-ID/s:5
{
    ...
    {
        if([AUTO.0]%2==0 && write==0) {getStatus(AUTO, &kond); kond[0]=49; setStatus(AUTO, &kond);}
    }
}