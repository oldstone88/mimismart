/*
{
    ...
    {name:"U10",type:"devices-list",required:false,filter:["lamp"],width:888,desc:"Ресивер"},
    {name:"U11",type:"devices-list",required:false,filter:["lamp", "dimer-lamp"],width:888,desc:"Стена"},
...
V-ID/V-ADDR
{
    if (([V-ADDR.0]&1)==1)
    {
        ...
        #ifdef U11 setStatus(U11, {1, 250, 1}); #endif
