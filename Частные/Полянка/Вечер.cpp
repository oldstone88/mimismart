/*
{
	...
	vars:[
		...
		{name:"L00",type:"devices-list",required:false,width:600,filter:["lamp", "dimer-lamp"],descAlign:"top",desc:"Детское бра",descWidth:100},
		{name:"L01",type:"devices-list",required:false,width:600,filter:["lamp", "dimer-lamp"],descAlign:"top",desc:"Мастер бра 1",descWidth:100},
		{name:"L02",type:"devices-list",required:false,width:600,filter:["lamp", "dimer-lamp"],descAlign:"top",desc:"Мастер бра 2",descWidth:100},
		{name:"L03",type:"devices-list",required:false,width:600,filter:["lamp", "dimer-lamp"],descAlign:"top",desc:"Мастер люстра",descWidth:100},
		{name:"L04",type:"devices-list",required:false,width:600,filter:["lamp", "dimer-lamp"],descAlign:"top",desc:"Кухня люстра",descWidth:100},
		{name:"L05",type:"devices-list",required:false,width:600,filter:["lamp", "dimer-lamp"],descAlign:"top",desc:"Кухня бра",descWidth:100},
		{name:"L06",type:"devices-list",required:false,width:600,filter:["lamp", "dimer-lamp"],descAlign:"top",desc:"Гостиная люстра",descWidth:100},
		{name:"L07",type:"devices-list",required:false,width:600,filter:["lamp", "dimer-lamp"],descAlign:"top",desc:"Свет 07",descWidth:100},
