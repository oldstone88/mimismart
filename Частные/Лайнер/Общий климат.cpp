/*
{
  ...
  name:"Отпуск",
  vars:[
  {type:"comment",text:"Авто режим"},
  {name:"AUTO",type:"devices-list",required:false,width:1000,filter:["script"],desc:"Авто-режим",descWidth:100},
...
if(([AUTO.0]&1)==1){
  ...
  u16 level=([CO20.1]*100+[CO20.0]*100/255); // расчет со2
  if( level>BIGCO2 ){
      error |= 1<<0;
