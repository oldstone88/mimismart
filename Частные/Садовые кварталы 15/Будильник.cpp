...
V-ID/V-ADDR
{
  if((opt(0)&1)==1)
  {
    ...
    bright=0;
      ...
      #ifdef JAL00 if( ([JAL00.0]&7)!=1 ) {setStatus(JAL00, 1);} #endif
      #ifdef JAL01 if( ([JAL01.0]&7)!=1 ) {setStatus(JAL01, 1);} #endif
      #ifdef JAL02 if( ([JAL02.0]&7)!=1 ) {setStatus(JAL02, 1);} #endif
