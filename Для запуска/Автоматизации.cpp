...
V-ID/V-ADDR
{
    if ([V-ADDR.0]==0)
    {
        ...
        #ifdef U50 setAutoState(U50, 0xFFFE); #endif
        #ifdef U51 setAutoState(U51, 0xFFFE); #endif
        #ifdef U52 setAutoState(U52, 0xFFFE); #endif
        #ifdef U53 setAutoState(U53, 0xFFFE); #endif
        #ifdef U54 setAutoState(U54, 0xFFFE); #endif
        #ifdef U55 setAutoState(U55, 0xFFFE); #endif
        #ifdef U56 setAutoState(U56, 0xFFFE); #endif
        #ifdef U57 setAutoState(U57, 0xFFFE); #endif
        #ifdef U58 setAutoState(U58, 0xFFFE); #endif
        #ifdef U59 setAutoState(U59, 0xFFFE); #endif
        #ifdef U60 setAutoState(U60, 0xFFFE); #endif
        #ifdef U61 setAutoState(U61, 0xFFFE); #endif
        #ifdef U62 setAutoState(U62, 0xFFFE); #endif
        #ifdef U63 setAutoState(U63, 0xFFFE); #endif
        #ifdef U64 setAutoState(U64, 0xFFFE); #endif
        #ifdef U65 setAutoState(U65, 0xFFFE); #endif
        #ifdef U66 setAutoState(U66, 0xFFFE); #endif
    ...
    } else
    {
        ...
        #ifdef U50 setAutoState(U50, 0); #endif
        #ifdef U51 setAutoState(U51, 0); #endif
        #ifdef U52 setAutoState(U52, 0); #endif
        #ifdef U53 setAutoState(U53, 0); #endif
        #ifdef U54 setAutoState(U54, 0); #endif
        #ifdef U55 setAutoState(U55, 0); #endif
        #ifdef U56 setAutoState(U56, 0); #endif
        #ifdef U57 setAutoState(U57, 0); #endif
        #ifdef U58 setAutoState(U58, 0); #endif
        #ifdef U59 setAutoState(U59, 0); #endif
        #ifdef U60 setAutoState(U60, 0); #endif
        #ifdef U61 setAutoState(U61, 0); #endif
        #ifdef U62 setAutoState(U62, 0); #endif
        #ifdef U63 setAutoState(U63, 0); #endif
        #ifdef U64 setAutoState(U64, 0); #endif
        #ifdef U65 setAutoState(U65, 0); #endif
        #ifdef U66 setAutoState(U66, 0); #endif
