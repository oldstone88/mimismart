/*
{
  ...
  vars:[
	...
	{name:"MOTION9",type:"devices-list",required:false, filter:["motion-sensor"],desc:"Датчик движения3"},
   	...
   	{name:"V00",type:"devices-list",required:false, filter:["lamp"],desc:"Вытяжка 0"},
   	{name:"V01",type:"devices-list",required:false, filter:["lamp"],desc:"Вытяжка 1"},
   	{name:"V02",type:"devices-list",required:false, filter:["lamp"],desc:"Вытяжка 2"},
   	{name:"V03",type:"devices-list",required:false, filter:["lamp"],desc:"Вытяжка 3"},
   	{name:"V04",type:"devices-list",required:false, filter:["lamp"],desc:"Вытяжка 4"},
   	{name:"V05",type:"devices-list",required:false, filter:["lamp"],desc:"Вытяжка 5"},
   	{name:"V06",type:"devices-list",required:false, filter:["conditioner"],desc:"Вениляция 0"},
