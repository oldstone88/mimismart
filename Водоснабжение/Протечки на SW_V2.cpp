...
V-ID/s:1
{
    ...
    #ifdef H02 if([H02.0]==0 && ([V-ADDR.0]&1)==0) { if(i[2]<=12) i[2]=i[2]+1; else {if(antispam==0) setStatus(2047:32, {8, "T02"}); alarm=1;}    } else i[2]=0; #endif
    #ifdef H03 if([H03.0]==0 && ([V-ADDR.0]&1)==0) { if(i[3]<=12) i[3]=i[3]+1; else {if(antispam==0) setStatus(2047:32, {8, "T03"}); alarm=1;}    } else i[3]=0; #endif
    #ifdef H04 if([H04.0]==0 && ([V-ADDR.0]&1)==0) { if(i[4]<=12) i[4]=i[4]+1; else {if(antispam==0) setStatus(2047:32, {8, "T04"}); alarm=1;}    } else i[4]=0; #endif
    #ifdef H05 if([H05.0]==0 && ([V-ADDR.0]&1)==0) { if(i[5]<=12) i[5]=i[5]+1; else {if(antispam==0) setStatus(2047:32, {8, "T05"}); alarm=1;}    } else i[5]=0; #endif
    #ifdef H06 if([H06.0]==0 && ([V-ADDR.0]&1)==0) { if(i[6]<=12) i[6]=i[6]+1; else {if(antispam==0) setStatus(2047:32, {8, "T06"}); alarm=1;}    } else i[6]=0; #endif
    #ifdef H07 if([H07.0]==0 && ([V-ADDR.0]&1)==0) { if(i[7]<=12) i[7]=i[7]+1; else {if(antispam==0) setStatus(2047:32, {8, "T07"}); alarm=1;}    } else i[7]=0; #endif
    #ifdef H08 if([H08.0]==0 && ([V-ADDR.0]&1)==0) { if(i[8]<=12) i[8]=i[8]+1; else {if(antispam==0) setStatus(2047:32, {8, "T08"}); alarm=1;}    } else i[8]=0; #endif
    #ifdef H09 if([H09.0]==0 && ([V-ADDR.0]&1)==0) { if(i[9]<=12) i[9]=i[9]+1; else {if(antispam==0) setStatus(2047:32, {8, "T09"}); alarm=1;}    } else i[9]=0; #endif
    #ifdef H10 if([H10.0]==0 && ([V-ADDR.0]&1)==0) { if(i[10]<=12) i[10]=i[10]+1; else {if(antispam==0) setStatus(2047:32, {8, "T10"}); alarm=1;} } else i[10]=0; #endif
    #ifdef H11 if([H11.0]==0 && ([V-ADDR.0]&1)==0) { if(i[11]<=12) i[11]=i[11]+1; else {if(antispam==0) setStatus(2047:32, {8, "T11"}); alarm=1;} } else i[11]=0; #endif
    #ifdef H12 if([H12.0]==0 && ([V-ADDR.0]&1)==0) { if(i[12]<=12) i[12]=i[12]+1; else {if(antispam==0) setStatus(2047:32, {8, "T12"}); alarm=1;} } else i[12]=0; #endif
