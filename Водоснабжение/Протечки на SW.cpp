...
V-ID/H00
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg0, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg0);
}

#ifdef H01
V-ID/H01
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg1, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg1);
}
#endif
...
V-ID/H02
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg2, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg2);
}
#endif
...
V-ID/H03
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg3, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg3);
}
#endif
...
V-ID/H04
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg4, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg4);
}
#endif
...
V-ID/H05
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg5, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg5);
}
#endif
...
V-ID/H06
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg6, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg6);
}
#endif
...
V-ID/H07
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg7, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg7);
}
#endif
...
V-ID/H08
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg8, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg8);
}
#endif
...
V-ID/H09
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg9, 7);} else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg9);
}
#endif
...
V-ID/H10
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg10, 7);}  else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg10);
}
#endif
...
V-ID/H11
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg11, 7);}  else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg11);
}
#endif
...
V-ID/H12
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg12, 7);}  else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg12);
}
#endif
...
V-ID/H13
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg13, 7);}  else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg13);
}
#endif
...
V-ID/H14
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg14, 7);}  else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg14);
}
#endif
...
V-ID/H15
{
    if ( (opt(0)&1)==0 && ([V-ADDR.0]&1)==0 ) {delayedCall(drebezg15, 7);}  else if((opt(0)&1)==1 && ([V-ADDR.0]&1)==0) cancelDelayedCall(drebezg15);
}
#endif
