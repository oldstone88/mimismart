/*
{
  ...
  vars:[
    ...
    {name:"ID4",type:"number",required:true,defaultValue:1,min:0,max:255,desc:"ID диммера",descWidth:350},
    {name:"DIMMER13",type:"devices-list",required:true,filter:["dimer-lamp"],desc:"Диммер 9",width:500},
    {name:"DIMMER14",type:"devices-list",required:true,filter:["dimer-lamp"],desc:"Диммер 10",width:500},
    {name:"DIMMER15",type:"devices-list",required:true,filter:["dimer-lamp"],desc:"Диммер 11",width:500},
    {name:"DIMMER16",type:"devices-list",required:true,filter:["dimer-lamp"],desc:"Диммер 12",width:500},
  ]
}
*/
...
V-ID/ms:150{
    ...
    //Уставка диммеров
        ...
        0x00, [DIMMER14.0]&1, 0x00, [DIMMER14.1], 0x00, 0x01, //18
        0x00, [DIMMER15.0]&1, 0x00, [DIMMER15.1], 0x00, 0x01, //24
        0x00, [DIMMER16.0]&1, 0x00, [DIMMER16.1], 0x00, 0x01, //30
        0xCC, 0x16}; //32
        setStatus(RS485, &data);
        numberidset=0;
        return;
